    ...
    <div class="container">
        <div class="row">
            <div class="Dhead_title text-center">
                <h2>User Area - Change Password</h2>
                ...
                <div class="col-md-offset-1 col-md-10  col-xs-12">
                    <div class="single_Dwedo">
                        ...
                        <div class="Dsingle_right_text">
                            ...
                            <form action="u_chpwd.php" method="post" id="formid">
                            ...
                            <p>
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    $sql = "UPDATE `zamzimh_user` SET `U_Password`='$newp' 
                                    WHERE `U_Password`='$oldp' AND `UserID`='$u_id'";
