    ...
    <div class="container">
        <div class="row">
            <div class="Dhead_title text-center">
                <h2>Supplier Area - My Services</h2>
                ...
                <div class="col-md-offset-1 col-md-10  col-xs-12">
                    <div class="single_Dwedo">
                        ...
                        <div class="Dsingle_right_text">
                            ...
                            $sql = "SELECT `ServiceID`, `Sv_Name`, `Sv_area`, `Sv_Price`, `Sv_Status` FROM `zamzimh_services` WHERE `SupplierID`='$sid'";
                            if ($result = mysqli_query($dbconn, $sql)) {
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        echo "<td class='long'><a class='tablelink' href='s_serviceupdate.php?svid=" . $row['ServiceID'] . "'>
        Edit</a>&nbsp;&nbsp;&nbsp;<a class='tablelink' href='s_servicedelete.php?svid=" . $row['ServiceID'] . "'>
        Delete</a></td>";
                                        echo "</tr> ";
                                    }
                                    echo "</table>";
                            ...
                            <a href="s_addnewservice.php" class="btn blue-btn">Add New Service</a>
                        </div>
                    </div>
                </div>
            </div>
