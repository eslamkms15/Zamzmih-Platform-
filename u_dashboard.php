				...
				<div class="col-md-offset-1 col-md-10  col-xs-12">
					<div class="single_Dwedo">
						...
						<div class="Dsingle_right_text">
							...
							$sql = "SELECT `NotifID`, `N_Text`, `N_Flag`, `ApptID`, `SupplierID` FROM `zamzimh_notification` WHERE `N_Receiver` = 'User' AND `UserID` = '$uid' ORDER BY `NotifID` DESC LIMIT 3;";
							...
							<a href="u_notification.php">All Notifications</a>
						</div>
					</div>
				</div>
			</div>
